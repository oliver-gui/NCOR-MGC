...
def case_33(total_samples = 200, noise_scale=0.15, batch_size=1, model_type = 'pretrainnet',device = 'cpu'):
    ...
    # DG Boundary define
    DG = np.array([[1],[-1]])
    random_vector = np.zeros([2,DG.shape[1]])
    ...
    DG_randn = np.vstack([DG, random_vector])
...
if __name__ == "__main__":
    ...
    n_train = 1000
    divide_mark = [[2,1],[2,1],[2,1],[2,1],[2,1],[2,1],[2,1],[2,1],[2,1],[2,1],[2,1],[2,1],[2,1]]
    divide_mark1 = [[10,3]]
